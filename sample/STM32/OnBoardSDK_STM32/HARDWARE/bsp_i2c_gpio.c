...
#define GPIO_PORT_I2C_SCL	GPIOA			/* GPIO端口 */
#define GPIO_PORT_I2C_SDA	GPIOC			/* GPIO端口 */
#define RCC_I2C_SCL_PORT 	RCC_AHB1Periph_GPIOA		/* GPIO端口时钟 */
#define RCC_I2C_SDA_PORT 	RCC_AHB1Periph_GPIOC		/* GPIO端口时钟 */
...
void bsp_InitI2C(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_I2C_SCL_PORT, ENABLE);	/* 打开GPIO时钟 */
	RCC_AHB1PeriphClockCmd(RCC_I2C_SDA_PORT, ENABLE);	/* 打开GPIO时钟 */
