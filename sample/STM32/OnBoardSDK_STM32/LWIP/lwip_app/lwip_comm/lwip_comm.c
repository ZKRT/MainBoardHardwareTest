...
//network user timer
u32 check_linkstatus_timer=0; //检查网线连接状态时间，每5秒检测一遍
...
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
	...
	lwipx->ip[1]=168;
	lwipx->ip[2]=1;
	lwipx->ip[3]=199;  //zkrt_notice: 默认地址199
